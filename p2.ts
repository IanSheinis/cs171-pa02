...
const this_client = 2; //TODO: change when copying over
let local_clock = 0;
...
function initiateClockServer() {
    const server = net.createServer(function(socket) {
        console.log("P2 : connection from", socket.remoteAddress, "port", socket.remotePort)//TODO
    ...
    server.listen(port_p2, function() { // TODO when copying change each to right port
