...
import { Client, ClientRequestEnum, MasterRequestEnum, port_p1, port_p2, sleep } from "./config";
...
function initiateClockServer() {
    const server = net.createServer(function(socket) {
        console.log("P2 : connection from", socket.remoteAddress, "port", socket.remotePort)
    ...
    server.listen(port_p2, function() {
        console.log("P2 socket is listening...");
    });
}
