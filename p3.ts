...
const this_client = 3; //TODO: change when copying over
let local_clock = 0;
...
function initiateClockServer() {
    const server = net.createServer(function(socket) {
        console.log("P3 : connection from", socket.remoteAddress, "port", socket.remotePort)//TODO
    ...
    server.listen(port_p3, function() { // TODO when copying change each to right port
